...
#python recognize.py --detector ./face_detection_model --embedding-model nn4.small2.v1.t7 --recognizer ./output/recognizer.pickle --le ./output/le.pickle --image ./images/11.jpg